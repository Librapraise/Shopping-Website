...
const ProfilePage = async () => {
  ...
  const user = await wixClient.members.getCurrentMember({
    fieldsets: [wixClient.members.Set.FULL],
  });
  ...
  return (
    <div className="flex flex-col md:flex-row gap-24 md:h-[calc(100vh-30px)] items-center px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
